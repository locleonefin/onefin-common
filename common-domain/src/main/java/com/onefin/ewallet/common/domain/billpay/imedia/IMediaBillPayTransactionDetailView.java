 ...
 * Query for this view:
 * 
DROP TABLE IF EXISTS iomedia_billpay_transaction_detail_view;
CREATE OR REPLACE VIEW iomedia_billpay_transaction_detail_view AS SELECT 
		a.*
FROM 
  ((SELECT 
	bt.id as id,
...
@Data
@Entity
@Table(name = "imedia_billpay_transaction_detail_view")
public class IMediaBillPayTransactionDetailView {
    ...
    public boolean equals(Object o) {
        ...
        com.onefin.ewallet.common.domain.billpay.imedia.IMediaBillPayTransaction that = (com.onefin.ewallet.common.domain.billpay.imedia.IMediaBillPayTransaction) o;
