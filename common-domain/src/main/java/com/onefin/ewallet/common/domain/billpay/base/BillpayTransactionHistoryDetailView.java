 ...
 * Query for this view:
 * 
  DROP TABLE IF EXISTS billpay_transaction_history_detail_view;
  CREATE OR REPLACE VIEW billpay_transaction_history_detail_view AS SELECT 
		a.*
  FROM 
	((SELECT
		vt.id as id,
		vt.cust_id as bill_no,
		vt.of_bill_id as bill_id,
		vt.bill_cycle as bill_cycle,
		vt.bill_name as bill_name,
		vt.bill_address as bill_address,
		vt.amount as amount,
		vt.currency_code as currency,
	...
	(SELECT
		...
		iom.bill_address as bill_address,
...
@Data
@Entity
@Table(name = "billpay_transaction_history_detail_view")
public class BillpayTransactionHistoryDetailView {
    ...
    public boolean equals(Object o) {
        ...
        BillpayTransactionHistoryDetailView that = (BillpayTransactionHistoryDetailView) o;
